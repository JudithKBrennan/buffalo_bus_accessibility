...
def accessibility(origins: pd.DataFrame, destinations: pd.DataFrame, results: pd.DataFrame):
    '''
    Parameters
    ----------
    origins
    ...
    all_od_pairs = [(i, j) for i in range(1, number_of_origins + 1) for j in range(1, number_of_destinations + 1)]
...
if __name__ == '__main__':
    ...
    accessibility = accessibility(origins, destinations, results)