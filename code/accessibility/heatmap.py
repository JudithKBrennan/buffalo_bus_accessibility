...
def aggregateResults(df: pd.DataFrame, agg_func: str):
    '''
...
def createHeatmap(df, agg_metric, preference):
    '''
    ...
    agg_metric: str
        metric that will be used on the heatmap
    ...
    grouped = aggregateResults(df, agg_metric)
    ...
    # Save to HTML file
    m.save(f'heatmap_{preference}_{agg_metric}.html')
